        ...
        with col_comment:
            ...
            if filtered_comments:
                if comment_view == "リスト":
                    ...
                    # 'user_id'が存在しない場合に備えて、デフォルト値を設定
                    safe_comments = [log.get('user_id', 'N/A') for log in filtered_comments]
                    ...
                    comment_df['user_id'] = safe_comments
